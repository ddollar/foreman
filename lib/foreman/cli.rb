...
class Foreman::CLI < Thor
  ...
  method_option :concurrency,      :type => :string,  :aliases => "-c", :banner => '"alpha=5,bar=3"'
  method_option :"alert-on-mem",   :type => :string, :banner => '"alpha=150 MB,bar=250 MB" or "200 MB"'
  method_option :"restart-on-mem", :type => :string, :banner => '"alpha=200 MB,bar=300 MB" or "300 MB"'
